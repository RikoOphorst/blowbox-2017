...
namespace blowbox
{
	...
	private:
		eastl::unordered_map<ColorBufferType, ColorBuffer> buffers_color_;
		eastl::unordered_map<DepthBufferType, DepthBuffer> buffers_depth_;
		eastl::unordered_map<ByteBufferType, ByteAddressBuffer> buffers_byte_address_;
		eastl::unordered_map<TypedBufferType, TypedBuffer> buffers_typed_;
		eastl::unordered_map<StructuredBufferType, StructuredBuffer> buffers_structured_;
	};
}